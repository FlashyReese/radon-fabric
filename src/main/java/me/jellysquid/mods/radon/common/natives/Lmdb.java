...
public class Lmdb {
    ...
    public static class MDB_val implements AutoCloseable, Addressable {
        ...
        private final MemorySegment storage = MemorySegment.allocateNative(LAYOUT, ResourceScope.newConfinedScope());
        ...
        public MemorySegment getValue() {
            ...
            return address.asSegment(size, ResourceScope.newConfinedScope());
        }
